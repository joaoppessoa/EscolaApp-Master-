var pesquisarAvaliacaoDeUmaEscolaPorAnoCtrl = function($scope, $mdToast, tipoAvaliacaoApi) {
    $scope.avaliacoes = [];
    $scope.pesquisarAvaliacaoDeUmaEscolaPorAno = function(codEscola, ano) {
        tipoAvaliacaoApi.getPesquisarAvaliacaoDeUmaEscolaPorAno(codEscola, ano)
